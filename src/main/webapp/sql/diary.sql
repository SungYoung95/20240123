...
insert into diary(dID,dTITLE,dFROMID,dGROUPID,dDATE,dCONTENT,dEMOTION, dWEATHER, dSHARECHECK)
    values(11111111,'첫글','USER1',1,TO_DATE('20240115201430','YYYYMMDDHH24MISS'),'안녕하세요~ 제가 첫빠입니다ㅎ','HAPPY','SUN','SHARE');
insert into diary(dID,dTITLE,dFROMID,dDATE,dCONTENT,dEMOTION, dWEATHER, dSHARECHECK)
    values(22222222,'두번째글','USER2',TO_DATE('20240116221430','YYYYMMDDHH24MISS'),'안녕하세요~ 제가 두번째입니다ㅎ','SAD','RAINY','NO_SHARE');
insert into diary(dID,dTITLE,dFROMID,dGROUPID,dDATE,dCONTENT,dEMOTION, dWEATHER, dSHARECHECK)
    values(33333333,'세번째글','USER3',2,TO_DATE('20240117233530','YYYYMMDDHH24MISS'),'안녕하세요~ 제가 세번째입니다ㅎ','SOSO','CLOUD','SHARE');
insert into diary(dID,dTITLE,dFROMID,dDATE,dCONTENT,dEMOTION, dWEATHER, dSHARECHECK)
    values(44444444,'네번째글','USER1',TO_DATE('20240117235530','YYYYMMDDHH24MISS'),'네번째글입니다.','SOSO','SUN','NO_SHARE');

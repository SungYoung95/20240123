...
public class DiaryRestController {
	...
	public void deleleMyOldDiary(@RequestParam("dID") Long dID) {
	...
	public void deleteReceivedDiary(@RequestParam("dID") Long dID,
									HttpServletRequest request) {
		...
		String uID = (String)request.getSession().getAttribute("userID");
		Long dGROUPID = findDiary.getDGROUPID();
		diaryService.updateReceivedDiaryDeleteCheck(dGROUPID, dID, uID);
	}

...
public interface DiaryShareRepository extends JpaRepository<DiaryShareVO, Long>{
	...
	// select count(*) from diary_share where dsid = 'USER2' and dsreadcheck = 'NO_READ';
	@Query("select COUNT(ds) from DiaryShareVO ds where ds.dsID = :username and ds.dsREADCHECK = 'NO_READ'")
